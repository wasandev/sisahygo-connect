...
@php
    $menuItems = [
        ...
        ['label' => 'Order Checking', 'route' => 'order-checking'],
...
<div x-data="{ drawerOpen: false, userMenuOpen: false }" x-on:keydown.escape.window="drawerOpen = false; userMenuOpen = false">
    <aside class="fixed inset-y-0 left-0 z-40 hidden w-72 border-r border-slate-200 bg-white lg:flex lg:flex-col">
        ...
        <div class="border-t border-slate-100 p-4">
            <div class="rounded-lg bg-slate-50 p-4">
                <p class="text-sm font-semibold text-connect-navy-900">{{ auth()->user()->name }}</p>
    ...
    >
        ...
        <aside
            x-show="drawerOpen"
            x-transition
            class="fixed inset-y-0 left-0 flex w-80 max-w-[85vw] flex-col bg-white shadow-xl"
        >
        ...
        <div class="flex h-full items-center justify-between gap-4 px-4 sm:px-6 lg:px-8">
            <div class="flex min-w-0 items-center gap-3">
                ...
                <div class="min-w-0">
                    ...
                    <h1 class="truncate text-xl font-semibold text-connect-navy-900 sm:text-2xl">{{ $title }}</h1>
                </div>
            </div>
            ...
            <div class="flex items-center gap-2">
                ...
                <div class="relative">
                    <button
                        ...
                        class="connect-focus flex items-center gap-2 rounded-lg border border-slate-200 bg-white px-2 py-2 text-left shadow-sm transition hover:bg-slate-50"
                    >
                        ...
                        <span class="hidden min-w-0 sm:block">
                            ...
                            <span class="block truncate text-xs text-slate-500">Account</span>
                        </span>
                    ...
                    <div
                        ...
                        class="absolute right-0 mt-2 w-56 rounded-lg border border-slate-200 bg-white py-2 shadow-lg"
                    >
